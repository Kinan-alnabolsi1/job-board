...
class __PostController extends Controller
{
    ...
    // Post::factory(10)->create(); //create 100 posts using the factory

    //  return response(["message" => "successfully created 100 posts"],201);
    // }

    // public function delete($id) {
    //     Post::destroy($id); //delete the post by id
    //     return response(["message" => "successfully deleted post with id $id"],200);
    // }
